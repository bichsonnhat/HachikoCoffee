...
public class YourVoucherAdapter extends RecyclerView.Adapter<YourVoucherAdapter.DiscountViewHolder>{
    private final List<DiscountDomain> mListDiscount;
    private final DiscountClickListener discountClickListener;

    public YourVoucherAdapter(List<DiscountDomain> mListDiscount, DiscountClickListener discountClickListener) {
